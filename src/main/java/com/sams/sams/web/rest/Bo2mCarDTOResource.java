...
public class Bo2mCarDTOResource {
    ...
    public ResponseEntity<List<Bo2mCarDTO>> getAllBo2mCarDTOS(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
