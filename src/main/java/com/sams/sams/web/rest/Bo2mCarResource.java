...
public class Bo2mCarResource {
    ...
    public ResponseEntity<List<Bo2mCar>> getAllBo2mCars(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
